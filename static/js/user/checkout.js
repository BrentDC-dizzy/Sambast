    ...
    const renderCheckout = async () => {
        ...
        if (checkoutItems.length === 0) {
            ...
            checkoutItems.forEach(item => {
                ...
                div.innerHTML = `
                    <div class="checkout-img"><img src="${imgSrc}" alt="${item.name}" style="width:100%;height:100%;object-fit:cover;border-radius:4px;" onerror="this.onerror=null;this.src='/static/img/user/user-male-circle.png';"></div>
